        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-center flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <img src="<?php echo assets_url; ?>media/images/internalDoctors.png" class="h-40px  align-self-center"
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0 mr-7 mt-4">
                                    <div class="symbol symbol-50 symbol-lg-130 symbol-circle">
                                        <img alt="Pic" src="<?php echo upload_url.$this->session->userdata('Profile_Image'); ?>">
                                    </div>
                                </div>
                                <!--end::Pic-->
                                <!--begin: Info-->
                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                                        ...
                                        <div class="mr-3">
                                            <!--begin::Name-->
                                            <a href="#" class="d-flex align-items-center text-dark text-hover-primary mt-n5 font-size-h5 font-weight-bold mr-3"><?php echo $this->session->userdata('Name'); ?></a>
                                            <!--end::Name-->
                                            <!--begin::Contacts-->
                                        ...
                                        <div class="mr-3">
                                            ...
                                            <a href="#"
                                                class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3"><?php echo $this->main_model->getBranchData($this->session->userdata('Branch_Id'))[0]->Name; ?></a>
                                        ...
                                        <div class="my-lg-0 my-1">
                                            ...
                                            <div class="symbol symbol-50 symbol-lg-150 symbol-circle">
                                                <img alt="Pic" src="<?php echo assets_url; ?>media/images/topdoc.png">
                                            </div>
                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body mblu pt-2 wi-70 mx-auto ">
                                        <div class="flex-grow-0  align-items-center  ">
                                            <div class="mb-3 "><img src="<?php echo assets_url; ?>media/images/rewards.png"
                                            ...
                                            <ul class="nav nav-pills nav-fill flex-nowrap">
                                                ...
                                                <li class="nav-item w-90px ">
                                                    <a class="nav-link d-flex flex-column bgyello shadow-sm h-90px "
                                                        ...
                                                        <span
                                                            class="nav-text pt-3 pb-6 display5 text-light font-weight-bold"><?php echo $this->main_model->getDoctorReward($this->session->userdata('Id')); ?></span>
                                                    </a>
                                                ...
                                                <li class="nav-item w-90px mx-5  ">
                                                    <a class="nav-link d-flex flex-column bgmgreen shadow-sm h-90px"
                                                        ...
                                                        <span
                                                            class="nav-text pt-3 pb-6 display5 text-light font-weight-bold"><?php echo $this->main_model->getDoctorSettleReward($this->session->userdata('Id')); ?></span>
                                                    </a>
                                                </li>
                                                <!--begin::Nav Item-->
                                                <!--end::Nav Item-->
                                                <li class="nav-item w-90px ">
                                                    ...
                                                    <a class="nav-link d-flex flex-column bgdrkgreen shadow-sm h-90px "
                                                        ...
                                                        <span
                                                            class="nav-text pt-3 pb-6 display5 text-light font-weight-bold"> <?php echo $this->main_model->getDoctorBalanceReward($this->session->userdata('Id')); ?> </span>
                                                    </a>
