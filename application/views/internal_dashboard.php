            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-center flex-wrap mr-5">
                    ...
                    <img src="<?php echo assets_url; ?>media/images/internalDoctors.png"
                        ...
                        class=" h5 text-dark font-weight-bold my-1 mr-5">Internal Professionals</span>
                </div>
                <!--end::Page Heading-->
            </div>
            <div class="d-flex align-items-center flex-wrap">
                <?php if($this->main_model->getActiveStatus($this->session->userdata('Id')) !== false) { ?>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card card-custom gutter-a mt-3">
                        <!--begin::Header-->
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <span
                                                    class="text-danger font-weight-bolder d-block display5"><?php echo $this->main_model->getOverallPatientCountByGroup(); ?></span>
                                            </td>
