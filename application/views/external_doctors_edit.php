        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">External Professionals</h5>
                    <!--end::Page Title-->
            ...
            <div class="d-flex align-items-center flex-wrap">
                ...
                <a href="<?php echo base_url; ?>external-doctors" class="btn btn-danger btn-fixed-height font-weight-bolder font-size-sm px-5 my-1 mr-3">Back</a>
			</div>
        </div>
    </div>
    <!--end::Subheader-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="<?php if(!$edit) echo "form-group"; ?> col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <img src="<?php echo upload_url.$external_doctors->Profile_Image; ?>" width="100px">
                                        </div>
                                        <div class="col-lg-8">
                                ...
                                <div class="<?php if(!$edit) echo "form-group"; ?> col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <a href="<?php echo upload_url.$external_doctors->RCI; ?>" target="_blank">
                                                <img src="<?php echo upload_url.$external_doctors->RCI; ?>" width="100px">
                                            </a>
                                        </div>
                                        <div class="col-lg-8">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="name" value="<?php echo $external_doctors->Name; ?>" required>
                                </div>   
                                <div class="form-group col-lg-6">
                                    <label for="usr">Designation:</label>
                                    <input type="text" class="form-control" name="designation" value="<?php echo $external_doctors->Designation; ?>" required>
                                </div> 
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="number" class="form-control" name="aadhar"
                                        value="<?php echo $external_doctors->Aadhar; ?>">
                                </div> 

                                <div class="form-group col-lg-6">
                                    <label for="usr">Hospital Name:</label>
                                    <input type="text" class="form-control" name="hospital_name" value="<?php echo $external_doctors->Hospital_Name; ?>" required>
                                </div>  

                                <div class="form-group col-lg-6">
                                    <label for="usr">Hospital Address:</label>
                                    <input type="text" class="form-control" name="hospital_address" value="<?php echo $external_doctors->Hospital_Address; ?>" required>
                                </div>  
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <?php foreach($this->main_model->getBranchData() as $item): ?>
                                      <option value="<?php echo $item->Id; ?>" <?php echo ($item->Id == $external_doctors->Branch_Id) ? "selected" : "";?> ><?php echo $item->Name; ?></option>
                                      <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <?php foreach($this->main_model->getDepartmentData() as $item): ?>
                                      <option value="<?php echo $item->Id; ?>" <?php echo ($item->Id == $external_doctors->Department_Id) ? "selected" : "";?> ><?php echo $item->Name; ?></option>
                                      <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="email" class="form-control" value="<?php echo $external_doctors->Email; ?>" name="email">
                                </div>    
                                <div class="form-group col-lg-6">
                                        <label for="usr">Username: <span id="usernameDuplicate" class="text-danger"></span></label>
                                        <input type="text" class="form-control" onchange="checkUsername(this.value)" value="<?php echo $external_doctors->Username; ?>" name="username" required>
                                    </div>    
                                <div class="form-group col-lg-6">
                                    <label for="usr">Password:</label>
                                    <input type="text" class="form-control" value="<?php echo $external_doctors->Password; ?>" name="password" required>
                                </div>    
                                <div class="form-group col-lg-6">
                                    <label for="usr">Mobile:</label>
                                    <input type="number" class="form-control" value="<?php echo $external_doctors->Mobile; ?>" name="mobile">
                                </div>    
                                <div class="form-group col-lg-6">
                                    <label for="sel1">Gender:</label>
                                    <select class="form-control" name="gender">
                                    <option selected disabled>Select Gender</option>
                                    <?php if($external_doctors->Gender == "Male"): ?>
                                      <option value="Male" selected>Male</option>
                                      <option value="Female">Female</option>
                                    <?php elseif($external_doctors->Gender == "Female"): ?>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $external_doctors->Address; ?>" name="address">
                                </div> 
                                <div class="form-group col-lg-3">
                                    <label for="usr">State:</label>
                                    <input type="text" class="form-control"  value="<?php echo $external_doctors->State; ?>" name="state">
                                </div> 
                                <div class="form-group col-lg-3">
                                    <label for="usr">City:</label>
                                    <input type="text" class="form-control" value="<?php echo $external_doctors->City; ?>" name="city" >
                                </div> 
                                <div class="form-group col-lg-3">
                                    <label for="usr">Leave Entitle:</label>
                                    <input type="number" class="form-control"
                                        value="<?php echo $external_doctors->Leave; ?>" name="leave">
                                </div>
                                <div class="form-group col-lg-3">
                                    <label for="usr">Target:</label>
                                    <input type="number" class="form-control"
                                        value="<?php echo $external_doctors->Target; ?>" name="target">
                                </div>
                                <div class="col-lg-4">
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input type="time" class="form-control"
                                                    value="<?php echo $external_doctors->Morning_Open_Time; ?>" name="morningOpenTime">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label for="usr">Morning Timing To:</label>
                                                <input type="time" class="form-control"
                                                    value="<?php echo $external_doctors->Morning_Close_Time; ?>" name="morningCloseTime">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input type="time" class="form-control"
                                                    value="<?php echo $external_doctors->Noon_Open_Time; ?>" name="noonOpenTime">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label for="usr">Noon Timing To:</label>
                                                <input type="time" class="form-control"
                                                    value="<?php echo $external_doctors->Noon_Close_Time; ?>" name="noonCloseTime">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input type="time" class="form-control"
                                                    value="<?php echo $external_doctors->Evening_Open_Time; ?>" name="eveningOpenTime">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label for="usr">Evening Timing To:</label>
                                                <input type="time" class="form-control"
                                                    value="<?php echo $external_doctors->Evening_Close_Time; ?>" name="eveningCloseTime">
                                            </div>
                                        </div>
                                    </div>
                                <div class="form-group col-lg-3">
                                    <label for="usr">Date of Birth:</label>
                                    <input type="date" class="form-control" value="<?php echo $external_doctors->DOB; ?>" name="dob" >
                                </div> 
                                <div class="form-group col-lg-3">
                                    <label for="usr">Date of Joining:</label>
                                    <input type="date" class="form-control" value="<?php echo $external_doctors->DOJ; ?>" name="doj" >
                                </div> 
                                <div class="form-group col-lg-3">
                                    <label for="usr">Date of Anniversary:</label>
                                    <input type="date" class="form-control" value="<?php echo $external_doctors->DOA; ?>" name="doa" >
                                </div>
                                <div class="form-group col-lg-3">
                                        <label for="sel1">Weekly Off:</label>
                                        <input class="form-control" type="text" list="days" name="weekly_off" value="<?php echo $external_doctors->Weekly_Off; ?>">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <?php if($external_doctors->Is_Active == 1): ?>
                                      <option value="1" selected>Active</option>
                                      <option value="0">In Active</option>
                                    <?php elseif($external_doctors->Is_Active == 0): ?>
                            ...
                            <div class="row">
                                <?php if($edit): ?>
                                    <button type="submit" name="edit_external_doctors" class="btn btn-primary col-lg-4">Submit</button>
                                <?php else: ?>
                                    <button type="submit" name="add_external_doctors" class="btn btn-primary col-lg-4">Submit</button>
                                <?php endif; ?>
...
<script>
    ...
    var slotId = '';
        ...
        function editSlot(docId) {
            ...
            console.log(docId);
            $.ajax({
                url: "<?php echo base_url ?>edit-external-doctors-slot/" + openTime + '/' + closeTime + '/' + slotId + '/' + docId,
        ...
        function deleteSlot(id, docId) {
            $.ajax({
                url: "<?php echo base_url ?>delete-external-doctors-slot/" + id + '/' + docId,
                success: function (result) {
                    window.location.reload();
                }
            });
