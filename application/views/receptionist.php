        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Receptionist</h5>
                    <!--end::Page Title-->
            ...
            <div class="d-flex align-items-center flex-wrap">
                ...
                <button class="btn btn-primary btn-fixed-height font-weight-bolder font-size-sm px-5 my-1 mr-3"
                    data-toggle="collapse" data-target="#branchCard">Add Receptionist</button>
                <?php endif; ?>
            </div>
        </div>
    </div>
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="<?php if(!$edit) echo "form-group"; ?> col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <img src="<?php echo upload_url.$receptionist->Profile_Image; ?>"
                                                    width="100px">
                                            </div>
                                            <div class="col-lg-8">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control" name="branch" required>
                                            ...
                                            <option value="<?php echo $item->Id; ?>"
                                                <?php echo ($item->Id == $receptionist->Branch_Id) ? "selected" : "";?>>
                                                <?php echo $item->Name; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="usr">Aadhar: <span id="aadharDuplicate"
                                                class="text-danger"></span></label>
                                        <input type="number" class="form-control" name="aadhar"
                                            value="<?php echo $receptionist->Aadhar; ?>">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="usr">Name:</label>
                                        <input type="text" class="form-control" name="name"
                                            value="<?php echo $receptionist->Name; ?>" required>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="usr">Email:</label>
                                        <input type="email" class="form-control"
                                            value="<?php echo $receptionist->Email; ?>" name="email">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="usr">Username: <span id="usernameDuplicate"
                                                class="text-danger"></span></label>
                                        <input type="text" class="form-control" onchange="checkUsername(this.value)"
                                            value="<?php echo $receptionist->Username; ?>" name="username" required>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="usr">Password:</label>
                                        <input type="text" class="form-control"
                                            value="<?php echo $receptionist->Password; ?>" name="password" required>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="usr">Mobile:</label>
                                        <input type="number" class="form-control"
                                            value="<?php echo $receptionist->Mobile; ?>" name="mobile">
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="sel1">Gender:</label>
                                        <select class="form-control" name="gender">
                                            <option selected disabled>Select Branch</option>
                                            <?php if($receptionist->Gender == "Male"): ?>
                                            <option value="Male" selected>Male</option>
                                            <option value="Female">Female</option>
                                            <?php elseif($receptionist->Gender == "Female"): ?>
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?php echo $receptionist->Address; ?>" name="address">
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label for="usr">State:</label>
                                        <input type="text" class="form-control"
                                            value="<?php echo $receptionist->State; ?>" name="state">
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label for="usr">City:</label>
                                        <input type="text" class="form-control"
                                            value="<?php echo $receptionist->City; ?>" name="city">
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input type="time" class="form-control"
                                                    value="<?php echo $receptionist->Morning_Open_Time; ?>"
                                                    name="morningOpenTime">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label for="usr">Morning Timing To:</label>
                                                <input type="time" class="form-control"
                                                    value="<?php echo $receptionist->Morning_Close_Time; ?>"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input type="time" class="form-control"
                                                    value="<?php echo $receptionist->Noon_Open_Time; ?>"
                                                    name="noonOpenTime">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label for="usr">Noon Timing To:</label>
                                                <input type="time" class="form-control"
                                                    value="<?php echo $receptionist->Noon_Close_Time; ?>"
                                                    name="noonCloseTime">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input type="time" class="form-control"
                                                    value="<?php echo $receptionist->Evening_Open_Time; ?>"
                                                    name="eveningOpenTime">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label for="usr">Evening Timing To:</label>
                                                <input type="time" class="form-control"
                                                    value="<?php echo $receptionist->Evening_Close_Time; ?>"
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="date" class="form-control"
                                            value="<?php echo $receptionist->DOB; ?>" name="dob">
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label for="usr">Date of Joining:</label>
                                        <input type="date" class="form-control"
                                            value="<?php echo $receptionist->DOJ; ?>" name="doj">
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label for="usr">Date of Anniversary:</label>
                                        <input type="date" class="form-control"
                                            value="<?php echo $receptionist->DOA; ?>" name="doa">
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label for="usr">Leave Entitle:</label>
                                        <input type="number" class="form-control"
                                            value="<?php echo $receptionist->Leave; ?>" name="leave">
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label for="sel1">Weekly Off:</label>
                                        <input class="form-control" type="text" list="days" name="weekly_off" value="<?php echo $receptionist->Weekly_Off; ?>">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <select class="form-control" name="status" required>
                                            ...
                                            <?php elseif($receptionist->Is_Active == 0): ?>
                                ...
                                <div class="row">
                                    <?php if($edit): ?>
                                    <button type="submit" name="edit_receptionist"
                                        class="btn btn-primary col-lg-4">Submit</button>
                                    <?php else: ?>
                                    <button type="submit" name="add_receptionist"
                                        class="btn btn-primary col-lg-4">Submit</button>
                                    <?php endif; ?>
                                </div>
                            </form>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-custom  gutter-b">
                        <div class="card-header border-0 pt-1">
                            <h3 class="card-title ml-n6">
                                <span class="card-label font-weight-bolder font-size-h4 text-dark-75">Receptionist
                                    List</span>
                            </h3>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped" id="table1">
                                    <thead>
                                        ...
                                        <thead>
                                        <tbody>
                                            <?php $i = 1; foreach($this->main_model->getReceptionistData() as $item){ ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                ...
                                                <td><?php echo ($item->Leave - $this->main_model->getGrantedLeaveCountByUser($item->Id)); ?>
                                                </td>
                                                <td>

                                                    <?php echo ($item->Is_Active == 1) ? '<span class="btn btn-success">A</span>' : '<span class="btn btn-danger">I</span>'; ?>
                                                </td>
                                                <td><a href="<?php echo base_url; ?>receptionist/<?php echo $item->Id; ?>"
