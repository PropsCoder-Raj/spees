                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-xl-4 col-md-6 col-xs-6 col-sm-6">
                                            ...
                                            <a href="#"
                                                class="text-muted text-hover-primary font-weight-bold mr-lg-8 ">Telecaller</a>
                                        </div>
                                        <div class="col-lg-4 col-xl-4 col-md-6 col-xs-6 col-sm-6">
                                            <a href="#"
                                        ...
                                        <div class="col-lg-4 col-xl-4 col-md-6 col-xs-6 col-sm-6">
                                            <a href="#"
                                                class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold"><?php echo ($this->session->userdata('DOJ') != "") ? $this->session->userdata('DOJ') : "-"; ?></a>
                                            <a href="#"
                                                class="text-muted text-hover-primary font-weight-bold mr-lg-8 ">Date of
                                                Joining</a>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-xl-4 col-md-6 col-xs-6 col-sm-6">
                                            <a href="#"
                                                class="d-flex align-items-center text-dark text-hover-primary  font-size-h5 font-weight-bold "><?php echo $this->session->userdata('Gender'); ?></a>
                                            <a href="#"
                                                class="text-muted text-hover-primary font-weight-bold mr-lg-8 ">Gender</a>
                                        </div>
                                        <div class="col-lg-4 col-xl-4 col-md-6 col-xs-6 col-sm-6">
                                            <a href="#"
                                                class="d-flex align-items-center text-dark text-hover-primary  font-size-h5 font-weight-bold"><?php echo $this->session->userdata('Mobile'); ?></a>
                                            <a href="#"
                                                class="text-muted text-hover-primary font-weight-bold">Mobile</a>
                                        </div>
                                        <div class="col-lg-4 col-xl-4 col-md-6 col-xs-6 col-sm-6">
                                            <a href="#"
                                                class="d-flex align-items-center text-dark text-hover-primary  font-size-h5 font-weight-bold"><?php echo $this->session->userdata('Email'); ?></a>
                                            <a href="#"
                                                class="text-muted text-hover-primary font-weight-bold">Email</a>
                                        </div>
