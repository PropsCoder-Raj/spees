                    ...
                    <div class="card card-custom  gutter-b">
                        <div class="card-header border-0 pt-1">
                            <h3 class="card-title ml-n6">
                                <span class="card-label font-weight-bolder font-size-h4 text-dark-75">Hold Leads</span>
                            </h3>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-striped" id="table2">
                                    <thead>
                                        ...
                                        <thead>
                                        <tbody>
                                            <?php $i = 1; foreach($this->main_model->getHoldLeadData(($this->session->userdata('Role') != 1) ? $this->session->userdata('Id') : "") as $item){ ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
