    ...
    <div class="subheader py-6 py-lg-8 subheader-transparent" id="kt_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <a href="<?php echo base_url; ?>add-external-doctors" class="btn btn-primary btn-fixed-height font-weight-bolder font-size-sm px-5 my-1 mr-3">Add External Professional</a>
			</div>
        </div>
    </div>
    <!--end::Subheader-->
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-striped" id="table1">
                                    ...
                                    <thead>
                                    <tbody>
                                        <?php $i = 1; foreach($this->main_model->getExternalDoctorData() as $item){ ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                ...
                                                <td><a href="<?php echo base_url; ?>external-doctors/<?php echo $item->Id; ?>" class="btn btn-warning">Edit</a></td>
                                            </tr>
                                        <?php $i++; } ?>
                                    </tbody>
                                </table>
